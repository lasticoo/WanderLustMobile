...
public class DashboardNavigation extends AppCompatActivity implements NavigationBarView.OnItemSelectedListener {
    ...
    private void fetchUserDataFromDashboard() {
        ...
        volleyHandler.makeGetRequestWithHeaders(ApiConfig.DASHBOARD_URL, headers, new VolleyHandler.VolleyCallback() {
            ...
            public void onSuccess(String result) {
                ...
                try {
                    ...
                    if (status.equals("berhasil")) {
                        ...
                        Toast.makeText(DashboardNavigation.this, "Gagal mengambil data pengguna", Toast.LENGTH_SHORT).show();
                    }
                } catch (JSONException e) {
                    e.printStackTrace();
                    Toast.makeText(DashboardNavigation.this, "Terjadi kesalahan pada server", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onError(String error) {
                ...
                Toast.makeText(DashboardNavigation.this, "Kesalahan jaringan: " + error, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void showVerificationRequiredDialog() {
        ...
        okButton.setOnClickListener(v -> {
            dialog.dismiss();
            Intent intent = new Intent(DashboardNavigation.this, VerifikasiAkun.class);
